...
export function registerMaterialReadTools(server) {
    ...
    server.tool("get_material", "Get full details of a Material or Material Instance: domain, blend mode, shading model, parameters, expressions, referenced textures.", {
